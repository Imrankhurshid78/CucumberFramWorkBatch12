...
public class AddEmployeeSteps extends CommonMethods {
    ...
    @When("user enters first name middlename and last name")
    public void user_enters_first_name_middlename_and_last_name() {
       sendText(addEmployeePage.firstNameField,"Imran");
       sendText(addEmployeePage.middleNameField,"Khan");
       sendText(addEmployeePage.lastNameField,"Khattak");
    }
